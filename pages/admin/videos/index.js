...
export default function Videos() {
  const apiUrl = "http://api.ineffablely.site";
      ...
      <div className="w-full h-full">
        <div className="w-full h-screen p-16 pb-32 overflow-y-scroll">
          ...
          <Link href={"/admin/videos/add"}>
            <div className="w-fit h-12 bg-blue-500 text-white flex items-center justify-center my-4 px-4 rounded-lg hover:bg-blue-600 transition-all ease-in-out duration-100">
              Add Video
            </div>
          </Link>
